...
## News ##
  * 1/8/17 Now in [Maven Central](https://mvnrepository.com/artifact/com.rapplogic/xbee-api). Going forward, releases will include xbee-socket so you can connect to XBees over an ip network to an xbee-serial-server.
